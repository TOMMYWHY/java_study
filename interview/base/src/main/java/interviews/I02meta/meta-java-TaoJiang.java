package interviews.I02meta;// 本试卷唯一 ID: 014E2F253FA160A74709973DAA3C39A4, 请勿修改本行内容
/* 注意, 这里不要写包名. 留空 */
...
class MetaJavaQuestionSheet {
    ...
    */
    ...
    /* qn8:
        ...
        E. SQL_2
    */
    public static String qn8 = "ABCDE";
    ...
    */
    ...
    public static boolean isTreeSymmetric(TreeNode root) {
        ...
        return is_mir(root,root);
    }
    private static boolean is_mir(TreeNode l, TreeNode r){
        if(l == null && r == null) return true;
        if(l == null || r == null) return false;
        if(l.val == r.val) {
            if(is_mir(l.left,r.right) && is_mir(l.right,r.left)){
                return true;
            }else{
                return false;
            }
